	...
	@php
		...
		$method = sprintf('%s_relationship', $row->field);		// for example:  subcategoriaIdRelationship
	...
	@if ( method_exists($model, $method) )
		...
		@php
			...
			if (!$data || $data === null){
			$data = [
			'subcategory' => $dataTypeContent->subcategory,
			'category' => $dataTypeContent->category,
			];
			}
